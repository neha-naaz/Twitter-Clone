          ...
          <div className="flex justify-center py-10">
            <div className="w-[80%] space-y-10">
              <div className="p-5 rounded-md flex items-center justify-between bg-slate-200 shadow-lg">
                ...
                <img
                  className="w-24 h-24"
                  src="https://thumbs.dreamstime.com/b/blue-tick-mark-verified-icon-circle-shape-agreement-approved-checkmark-sign-ok-checkbox-blue-tick-mark-sign-symbol-blue-387557369.jpg"
                  alt=""
                />
              </div>
